...
# File paths
input_file = "betterexample.csv"  # Replace with your export CSV file
output_file = "xero_import.csv"  # The file to import into Xero
template_file = "Xero SalesInvoiceTemplate.csv"  # The Xero template CSV file
